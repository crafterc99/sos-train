      ...
      <div className="bg-graphite border border-smoke rounded-2xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <Input
            label="Email"
            type="email"
            placeholder="coach@sostrain.com"
          ...
          <div className="text-right">
            <Link to="/reset-password" className="text-xs text-amber hover:text-blaze transition-colors">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-white/40">
          ...
          <Link to="/signup" className="text-amber hover:text-blaze transition-colors font-medium">
            Sign Up
          </Link>
        </p>
      </div>
